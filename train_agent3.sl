#!/bin/bash
#SBATCH --job-name=rl_gammon_agent3_ppo                           # Job name
#SBATCH --output=rl_gammon_agent3_ppo_%j.out                      # Standard output
#SBATCH --error=rl_gammon_agent3_ppo_%j.err                       # Standard error
...
echo "[INFO] Starting agent3_ppo.py..."
python3 -u agent3_ppo.py
